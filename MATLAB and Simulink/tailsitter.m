...
lift_left = q_w_left*S_w/2*(CL_0 + CL_f*f_left);
lift_right = q_w_right*S_w/2*(CL_0 + CL_f*f_right);

drag_left = q_w_left*S_w/2*CD_f*abs(f_left);
drag_right = q_w_right*S_w/2*CD_f*abs(f_right);
...
L_A = q_w_left*S_w/2*b*Cl_f*f_left - ...
    q_w_right*S_w/2*b*Cl_f*f_right; % roll from aerodynamics [N-m]
M_A = q_w_left*S_w/2*c_bar*(Cm_0 + Cm_f*f_left) + ...
    q_w_right*S_w/2*c_bar*(Cm_0 + Cm_f*f_right); % pitch from aerodynamics [N-m]
